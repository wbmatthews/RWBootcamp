...
class MediaPostsHandler: NSObject {
    ...
    func getPosts() {
        ...
        let textPost2 = TextPost(textBody: "This is my favorite social media app! This is my favorite social media app! This is my favorite social media app!", userName: "Jeff", timestamp: Date(timeIntervalSince1970: 40000))
