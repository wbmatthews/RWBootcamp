...
struct LinkView: View {
  ...
  var availableConnections: [[Ticker]] {
    [
      list.availableHeads.filter { $0 != selectedTicker },
      list.availableTails.filter { $0 != selectedTicker }
    ]
  }
...
struct LinkView_Previews: PreviewProvider {
  static var previews: some View {
    LinkView(selectedTicker: .demoTicker).environmentObject(TimerStackList())
  }
}
